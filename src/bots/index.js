...
import CryptoTapBot from "./crypto-tap-bot";
...
const cryptoTapBot = new CryptoTapBot(telegramBridgeBot);
...
export { bridgeBot, cryptoTapBot, instantTradesBot, orderBookCreationBot, orderBookContributionBot }
